...
df_97 <- df_97 %>%
  ...
  left_join(sites, df_97, by = c("site_name" = "site")) %>%
  ungroup()
...
venn(families, opacity = 0.4, zcolor = c("#d0681e","#1e74d0"), ggplot = TRUE)
ggsave("~/DATA/figures/family-venn.png")
...
venn(genera, opacity = 0.4, zcolor = c("#d0681e","#1e74d0"), ggplot = TRUE)
ggsave("~/DATA/figures/genera-venn.png")
# Bars
df_97 %>%
  filter(!is.na(order)) %>%
  ...
  ylab("Number (n)") + xlab("Order")
ggsave("~/DATA/figures/order-level-counts.png")
...
p1 <- ggplot(diversity_rich, aes(status, div)) +
  ...
  theme_minimal() + ylab("Diversity")
ggsave(plot = p1, "~/DATA/figures/diversity_rich.png")
...
p2 <- ggplot(diversity_shannon, aes(status, div)) +
  ...
  scale_fill_manual(values = c("#d0681e","#1e74d0")) +
  theme_minimal() + ylab("Diversity")
ggsave(plot = p2, "~/DATA/figures/diversity_shannon.png")
...
p3 <- ggplot(diversity_simpson, aes(status, div)) +
  ...
  scale_fill_manual(values = c("#d0681e","#1e74d0")) +
  theme_minimal() + ylab("Diversity")
ggsave(plot = p3, "~/DATA/figures/diversity_simpson.png")
...
x <- ggpubr::ggarrange(p1, p2, p3,
                       ...
                       labels = c("Richness",
                                  "Shannon",
                                  "Simpson"))
ggsave(plot = x, "~/DATA/figures/richness_shannon_simpson.png")
# T-test by year
t_status1 <- 
...
alpha_bar1 <- 
  ...
  stat_summary(fun = mean, geom = "point", shape = 24, size= 4, 
               color ="black", fill="white") +
  ylab("Diversity") + xlab("Year")
ggsave(plot = alpha_bar1, "~/DATA/figures/alpha-bar1.png")
...
alpha_bar2 <- 
  ...
  theme_minimal() +
  ylab("Diversity") + xlab("Year")
ggsave(plot = alpha_bar2, "~/DATA/figures/alpha-bar2.png")
...
alpha_bar3 <- 
  ...
  stat_summary(fun = mean, geom = "point", shape = 24, size= 4, 
               color ="black", fill="white") +
  ylab("Diversity") + xlab("Year")
ggsave(plot = alpha_bar3, "~/DATA/figures/alpha-bar3.png")
...
x2
ggsave(plot = x2, "~/DATA/figures/richness_shannon_simpson_2.png")

x3 <- ggpubr::ggarrange(p2, alpha_bar2,
                        labels = c("Burn versus Unburn",
                                  "Fall versus Spring"))
x3
ggsave(plot = x3, "~/DATA/figures/burnvsunburn_fallvsspring.png")
diversity_shannon %>% 
  ...
  ylab("Shannon Diversity") + xlab("Habitat Type")
ggsave("~/DATA/figures/shannon-diversity-habitat.png")
```
...
nmdseuc <- 
  ...
  theme_minimal()
ggsave(plot = nmdseuc, "~/DATA/figures/nmdseuc.png")
...
nmdsjacc <- 
  ...
  geom_text(aes(label = sample_name, color = status), size = 1) +
  theme_minimal()
ggsave(plot = nmdsjacc, "~/DATA/figures/nmdsjacc.png" )
